...
#                #Aggiunta mia 5 gennaio
#                s=tag.ndef.message.pretty()
#                strricerca="= '\x02en"
#                lens=len(s)
#                print(lens)
##                strliminiteminimo=s.rfind(strricerca)
##                strliminiteminimo=strliminiteminimo+9
##                print(strliminiteminimo)
##                print(s[68:])
#                stagliata=s[68:]
#                lenstagliata=len(stagliata)
#                stagliata=stagliata[:lenstagliata-1]
#                print(stagliata)
